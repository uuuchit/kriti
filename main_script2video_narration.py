"""Narration-synced script-to-video entrypoint.

Generates a video with TTS narration; shot durations are driven by
narration length, and the final video includes the narration track.

Requires GEMINI_API_KEY. Uses configs/script2video_narration.yaml.
"""

import asyncio
from pipelines.script2video_narration_pipeline import Script2VideoNarrationPipeline
...
async def main():
    pipeline = Script2VideoNarrationPipeline.init_from_config(
        config_path="configs/script2video_narration.yaml"
    )
